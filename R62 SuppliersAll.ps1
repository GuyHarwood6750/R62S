...
$outfile2 = 'C:\userdata\route 62\_all suppliers\suppliers september 2020_1.csv'                  #Change each month
$startR = 5                                             #Start row - does not change       
$endR = 144                                              #End Row - changes each month depending on number of invoices
