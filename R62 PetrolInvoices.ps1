...
#>
$csvclient = 'C:\userdata\route 62\petrol books\all20210624.csv'      #Input from Client spreadsheet
$outfile = 'C:\userdata\route 62\petrol books\petrolinv.txt'        #Temp file
$outfile2 = 'C:\userdata\route 62\petrol books\all20210624.txt'     #File to be imported into Pastel
